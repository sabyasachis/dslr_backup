...
STATIC_PREPROCESS_DATA_PATH  =  "../training_data/small_map/64beam_run_6/dynamic_prepreprocess_dir"
#DYNAMIC_PREPROCESS_DATA_PATH = "../training_data/small_map/16beam/dynamic_prepreprocess_dir"


if PREPROCESS_FRESHLY:
#    STATIC_TRAIN_FOLDER_PATH  = '/home/saby/Projects/ati/data/data/datasets/Carla/64beam-Data/dynamic/6/_out_out_npy'
    STATIC_TRAIN_FOLDER_PATH = "/home/saby/Projects/ati/data/data/datasets/Carla/16beam-Data/small_map/pair_transform_single/dynamic_out_npy"
...
#     DYNAMIC_VALID_FOLDER_PATH = DYNAMIC_TRAIN_FOLDER_PATH
    ...
    val_file  = sorted(os.listdir( STATIC_TRAIN_FOLDER_PATH), key=getint)[0]
