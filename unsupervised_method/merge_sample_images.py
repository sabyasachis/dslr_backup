...
for dynamic_file, reconstructed_file, static_file in tqdm(zip(dynamic_files, reconstructed_files, static_files), total=len(reconstructed_files)):
    ...
    merged_img_arr = np.concatenate((dynamic_img_arr, reconstructed_img_arr, static_img_arr), axis=1)
