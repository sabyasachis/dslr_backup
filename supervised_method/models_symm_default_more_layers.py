...
class VAE(nn.Module):
    def __init__(self, args):
        ...
        self.decoder_leakyrelu_j = nn.Sequential(nn.LeakyReLU(0.2, inplace=True))
        ...
        self.decoder_leakyrelu_l = nn.Sequential(nn.LeakyReLU(0.2, inplace=True))
        ...
        self.decoder_leakyrelu_n = nn.Sequential(nn.LeakyReLU(0.2, inplace=True))
        ...
        self.decoder_leakyrelu_p = nn.Sequential(nn.LeakyReLU(0.2, inplace=True))
